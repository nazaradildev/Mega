...
const SERVICES = [
  ...
  "Drone surveys for plant health assessment",
  "GIS maps for farm management",
];

export default function AgricultureFoodSecurityPage() {
  return (
          ...
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 text-center md:text-left p-8 bg-secondary rounded-lg">
                 <h2 className="text-3xl font-bold tracking-tighter">Enhance your agricultural productivity.</h2>
